...
title: "Legend State로 상태관리 마이그레이션 - React Hydration 지옥 탈출기"
description: "기존 상태관리에서 Legend State로 마이그레이션하면서 겪은 hydration mismatch 에러와 해결 과정"
createdAt: "2025/09/12"
updatedAt: ""
tags: ["React", "Legend State", "상태관리", "Hydration", "Next.js"]
featured: false
