---
slug: why-nestjs
title: 4년 후, 왜 NestJS로 갈아탔나
description: Express로 4년간 개발하다 NestJS로 전환한 이유
...
2019년부터 Express를 썼다. 4년 동안 30개 넘는 프로젝트를 Express로 만들었다.

그러다 2023년 말, 새 프로젝트에서 NestJS를 선택했다. Express가 싫어진 건 아니다. 그냥 필요해졌다.
