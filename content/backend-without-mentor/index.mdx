...
![빈 사무실에서 혼자 모니터를 바라보는 신입 개발자의 뒷모습](/blog/backend-without-mentor/01-alone.jpg)
...
![노트북 화면에 Node.js 강의 영상이 재생되고, 옆에 필기 노트가 있는 모습](/blog/backend-without-mentor/02-learning.jpg)
...
![왼쪽에 Java Spring 구조, 오른쪽에 Node.js 구조가 화살표로 매핑된 비교 다이어그램](/blog/backend-without-mentor/03-architecture.jpg)
...
![dbdiagram.io에서 ERD를 그리고 있는 화면 캡처 스타일 일러스트](/blog/backend-without-mentor/04-erd.jpg)
...
![복잡한 마이크로서비스 구조(X 표시)와 단순한 모놀리식 구조(O 표시) 비교](/blog/backend-without-mentor/05-monolithic.jpg)
...
![구글 검색창에 에러 메시지를 붙여넣기 하는 모습](/blog/backend-without-mentor/06-googling.jpg)
...
![AWS 콘솔 화면과 터미널이 나란히 있는 배포 작업 모습](/blog/backend-without-mentor/07-deploy.jpg)
...
![밤늦게 코딩하다가 Build Successful 메시지를 보고 기뻐하는 개발자](/blog/backend-without-mentor/08-success.jpg)
...
![자신감 있는 표정으로 코드 리뷰하는 개발자, 성장한 모습](/blog/backend-without-mentor/09-growth.jpg)
